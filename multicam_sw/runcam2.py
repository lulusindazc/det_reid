...
def reid_draw(frame, b_b, model, cfg, shujuku, threadPubMsg, camera_id, flag):
    ...
    threadPubMsg.set_customer(name=customer_name, person_id=6, camera_id=camera_id, x=left, y=top, w=right, h=bottom)
    threadPubMsg.set_commodity_recognition_trigger(camera_id=camera_id, flag1=flag1, flag2=flag2)

    print("camera_id = {}, person_id = 6".format(camera_id))

    if flag1==1 and flag2 == 0:
        print("flag1 = {}, flag2 = {}".format(flag1, flag2))
    if flag1==0 and flag2 == 1:
        rint("flag1 = {}, flag2 = {}".format(flag1, flag2))
    print("")
